...
public class FournisseurController {
	...
	@PutMapping("/affecterSecteurToFournisseur/{fournisseurId}/{secteurActiviteId}")

	void affecterSecteurToFournisseur(@PathVariable Long fournisseurId,@PathVariable Long secteurActiviteId){
